...
struct perturbations
{
  ...
  /* LSCF starts [VdF] */
  short has_source_delta_lscf;  /**< do we need source for delta from scalar field? */
  /* LSCF ends [VdF] */
  ...
  /* LSCF starts [VdF] */
  short has_source_theta_lscf;  /**< do we need source for theta of scalar field? */
  /* LSCF ends [VdF] */
  ...
  /* LSCF starts [VdF] */
  int index_tp_delta_lscf;  /**< index value for delta of scalar field */
  /* LSCF ends [VdF] */
  ...
  /* LSCF starts [VdF] */
  int index_tp_theta_lscf;   /**< index value for theta of scalar field */
  /* LSCF ends [VdF] */
...
struct perturbations_vector
{
  ...
  /* LSCF starts [VdF] */
  int index_pt_phi_lscf;  /**< scalar field density */
  int index_pt_phi_prime_lscf;  /**< scalar field velocity */
  /* LSCF ends [VdF] */
