...
/* LSCF starts [VdF] */
enum varconst_dependence {varconst_none,varconst_instant,varconst_zetalambda};
/* LSCF ends [VdF] */
...
struct background
{
  ...
  int index_bg_p_prime_scf;         /**< scalar field pressure */
   ...
   /* LSCF starts */
  int index_bg_phi_lscf;       /**< scalar field value */
  int index_bg_phi_prime_lscf; /**< scalar field derivative wrt conformal time */
  int index_bg_V_lscf;         /**< scalar field potential V */
  int index_bg_dV_lscf;        /**< scalar field potential derivative V' */
  int index_bg_ddV_lscf;       /**< scalar field potential second derivative V'' */
  int index_bg_rho_lscf;       /**< scalar field energy density */
  int index_bg_p_lscf;         /**< scalar field pressure */
  int index_bg_p_prime_lscf;         /**< scalar field pressure */
  /* LSCF ends */
  ...
  int index_bi_phi_prime_scf; /**< {B} scalar field derivative wrt conformal time */
   ...
   /* LSCF starts */
  int index_bi_phi_lscf;       /**< {B} scalar field value */
  int index_bi_phi_prime_lscf; /**< {B} scalar field derivative wrt conformal time */
    /* LSCF ends */
