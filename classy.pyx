...
cdef class Class:
    ...
    # LSCF starts [VdF] --------------------------------------------------------------
    def dlnalpha(self,z):
        return -self.ba.lscf_zeta*self.ba.lscf_lambda*np.log(1.+z)

    def eta(self):
        return 1.e-3*self.ba.lscf_zeta**2

    def drift(self):
        return self.ba.lscf_zeta*self.ba.lscf_lambda*1.02*self.ba.h

    def zeta(self):
        return self.ba.lscf_zeta

    def lambd(self):
        return self.ba.lscf_lambda
    # LSCF ends [VdF] ----------------------------------------------------------------
