    ...
    for (index_k=0; index_k<ppt->k_size[index_md]; index_k++) {
      ...
      if (output_format == class_format) {
        ...
        if (ppt->has_density_transfers == _TRUE_) {
          ...
          /* LSCF starts [VdF] */
          class_store_double(dataptr,tk[ppt->index_tp_delta_lscf],ppt->has_source_delta_lscf,storeidx);
          /* LSCF ends [VdF] */
        ...
        if (ppt->has_velocity_transfers == _TRUE_) {
          ...
          /* LSCF starts [VdF] */
           class_store_double(dataptr,tk[ppt->index_tp_theta_lscf],ppt->has_source_theta_lscf,storeidx);
          /* LSCF ends [VdF] */
...
int perturbations_output_titles(
  ...
  if (output_format == class_format) {
    ...
    if (ppt->has_density_transfers == _TRUE_) {
      ...
      /* LSCF starts [VdF] */
      class_store_columntitle(titles,"d_lscf",pba->has_lscf);
      /* LSCF ends [VdF] */
    ...
    if (ppt->has_velocity_transfers == _TRUE_) {
      ...
      /* LSCF starts [VdF] */
      class_store_columntitle(titles,"t_lscf",pba->has_lscf);
      /* LSCF ends [VdF] */
...
int perturbations_indices(
  ...
  /* LSCF starts [VdF] */
  ppt->has_source_delta_lscf = _FALSE_;
  /* LSCF ends [VdF] */
  ...
  /* LSCF starts [VdF] */
  ppt->has_source_theta_lscf = _FALSE_;
  /* LSCF ends [VdF] */
    ...
    if (_scalars_) {
      ...
      if (ppt->has_density_transfers == _TRUE_) {
        ...
        if (pba->has_lscf == _TRUE_)
          ppt->has_source_delta_lscf = _TRUE_;
          /* LSCF ends [VdF] */
        if (pba->has_ur == _TRUE_)
      ...
      if (ppt->has_velocity_transfers == _TRUE_) {
        ...
        if (pba->has_scf == _TRUE_)
          ...
          /* LSCF starts [VdF] */
        if (pba->has_lscf == _TRUE_)
          ppt->has_source_theta_lscf = _TRUE_;
          /* LSCF ends [VdF] */
        if (pba->has_ur == _TRUE_)
      ...
      /* LSCF starts [VdF] */
      class_define_index(ppt->index_tp_delta_lscf,  ppt->has_source_delta_lscf, index_type,1);
      /* LSCF ends [VdF] */
      ...
      /* LSCF starts [VdF] */
      class_define_index(ppt->index_tp_theta_lscf,  ppt->has_source_theta_lscf, index_type,1);
      /* LSCF ends [VdF] */
...
int perturbations_prepare_k_output(struct background * pba,
  ...
  if (ppt->k_output_values_num > 0) {
    ...
    if (ppt->has_scalars == _TRUE_){
      ...
      /* LSCF starts [VdF] */
      class_store_columntitle(ppt->scalar_titles, "delta_lscf", pba->has_lscf);
      class_store_columntitle(ppt->scalar_titles, "theta_lscf", pba->has_lscf);
      /* LSCF ends [VdF] */
      /** Fluid */
...
int perturbations_vector_init(
  ...
  if (_scalars_) {
    ...
    /* LSCF starts [VdF] */
    class_define_index(ppv->index_pt_phi_lscf,pba->has_lscf,index_pt,1); /* scalar field density */
    class_define_index(ppv->index_pt_phi_prime_lscf,pba->has_lscf,index_pt,1); /* scalar field velocity */
    /* LSCF ends [VdF] */
  ...
  /** - case of switching approximation while a wavenumber is being integrated */
    ...
    if (_scalars_) {
      ...
      if (pba->has_lscf == _TRUE_) {
        ...
        ppv->y[ppv->index_pt_phi_lscf] =
          ppw->pv->y[ppw->pv->index_pt_phi_lscf];

        ppv->y[ppv->index_pt_phi_prime_lscf] =
          ppw->pv->y[ppw->pv->index_pt_phi_prime_lscf];
      }
      /* LSCF ends [VdF] */
...
/* LSCF starts [VdF] */
     if (pba->has_lscf == _TRUE_) {
        ppw->pv->y[ppw->pv->index_pt_phi_lscf] = 0.;
        ppw->pv->y[ppw->pv->index_pt_phi_prime_lscf] = 0.;
      }
/* LSCF starts [VdF] */
    ...
    if (ppt->gauge == newtonian) {
      ...
      */
      ...
      if (pba->has_lscf == _TRUE_) {
        ...
        ppw->pv->y[ppw->pv->index_pt_phi_lscf] += alpha*ppw->pvecback[pba->index_bg_phi_prime_lscf];
        ppw->pv->y[ppw->pv->index_pt_phi_prime_lscf] +=
          (-2.*a_prime_over_a*alpha*ppw->pvecback[pba->index_bg_phi_prime_lscf]
           -a*a* dV_lscf(pba,ppw->pvecback[pba->index_bg_phi_lscf])*alpha
           +ppw->pvecback[pba->index_bg_phi_prime_lscf]*alpha_prime);
      }
      /* LSCF ends [VdF] */
...
int perturbations_total_stress_energy(
  ...
  /* LSCF starts [VdF] */
  double delta_rho_lscf, delta_p_lscf;
  /* LSCF ends [VdF] */
  ...
  if (_scalars_) {
    ...
    */
    ...
    if (pba->has_lscf == _TRUE_) {
      ...
      if (ppt->gauge == synchronous){
        delta_rho_lscf =  1./3.*
          (1./a2*ppw->pvecback[pba->index_bg_phi_prime_lscf]*y[ppw->pv->index_pt_phi_prime_lscf]
           + ppw->pvecback[pba->index_bg_dV_lscf]*y[ppw->pv->index_pt_phi_lscf]);
        delta_p_lscf = 1./3.*
          (1./a2*ppw->pvecback[pba->index_bg_phi_prime_lscf]*y[ppw->pv->index_pt_phi_prime_lscf]
           - ppw->pvecback[pba->index_bg_dV_lscf]*y[ppw->pv->index_pt_phi_lscf]);
      }
        ...
        delta_rho_lscf =  1./3.*
          (1./a2*ppw->pvecback[pba->index_bg_phi_prime_lscf]*y[ppw->pv->index_pt_phi_prime_lscf]
           + ppw->pvecback[pba->index_bg_dV_lscf]*y[ppw->pv->index_pt_phi_lscf]
           - 1./a2*pow(ppw->pvecback[pba->index_bg_phi_prime_lscf],2)*psi);
        delta_p_lscf =  1./3.*
          (1./a2*ppw->pvecback[pba->index_bg_phi_prime_lscf]*y[ppw->pv->index_pt_phi_prime_lscf]
           - ppw->pvecback[pba->index_bg_dV_lscf]*y[ppw->pv->index_pt_phi_lscf]
           - 1./a2*pow(ppw->pvecback[pba->index_bg_phi_prime_lscf],2)*psi);
      ...
      ppw->delta_rho += delta_rho_lscf;

      ppw->rho_plus_p_theta +=  1./3.*
        k*k/a2*ppw->pvecback[pba->index_bg_phi_prime_lscf]*y[ppw->pv->index_pt_phi_lscf];

      ppw->delta_p += delta_p_lscf;

      ppw->rho_plus_p_tot += ppw->pvecback[pba->index_bg_rho_lscf]+ppw->pvecback[pba->index_bg_p_lscf];
...
int perturbations_sources(
  ...
  /* LSCF starts [VdF] */
  double delta_rho_lscf, rho_plus_p_theta_lscf;
  /* LSCF ends [VdF] */
  ...
  if (_scalars_) {
    ...
    /* LSCF starts [VdF] */
    /* delta_lscf */
    if (ppt->has_source_delta_lscf == _TRUE_) {
      if (ppt->gauge == synchronous){
        delta_rho_lscf =  1./3.*
          (1./a2*ppw->pvecback[pba->index_bg_phi_prime_lscf]*y[ppw->pv->index_pt_phi_prime_lscf]
           + ppw->pvecback[pba->index_bg_dV_lscf]*y[ppw->pv->index_pt_phi_lscf])
          + 3.*a_prime_over_a*(1.+pvecback[pba->index_bg_p_lscf]/pvecback[pba->index_bg_rho_lscf])*theta_over_k2; // N-body gauge correction
      }
      else{
        delta_rho_lscf =  1./3.*
          (1./a2*ppw->pvecback[pba->index_bg_phi_prime_lscf]*y[ppw->pv->index_pt_phi_prime_lscf]
           + ppw->pvecback[pba->index_bg_dV_lscf]*y[ppw->pv->index_pt_phi_lscf]
           - 1./a2*pow(ppw->pvecback[pba->index_bg_phi_prime_lscf],2)*ppw->pvecmetric[ppw->index_mt_psi])
          + 3.*a_prime_over_a*(1.+pvecback[pba->index_bg_p_lscf]/pvecback[pba->index_bg_rho_lscf])*theta_over_k2; // N-body gauge correction
      }
      _set_source_(ppt->index_tp_delta_lscf) = delta_rho_lscf/pvecback[pba->index_bg_rho_lscf];
    }
    /* LSCF ends [VdF] */
    ...
    /* LSCF starts [VdF] */
    if (ppt->has_source_theta_lscf == _TRUE_) {

      rho_plus_p_theta_lscf = 1./3.*
        k*k/a2*ppw->pvecback[pba->index_bg_phi_prime_lscf]*y[ppw->pv->index_pt_phi_lscf];

      _set_source_(ppt->index_tp_theta_lscf) = rho_plus_p_theta_lscf/(pvecback[pba->index_bg_rho_lscf]+pvecback[pba->index_bg_p_lscf])
        + theta_shift; // N-body gauge correction
    }
    /* LSCF ends [VdF] */
...
int perturbations_print_variables(double tau,
  ...
  /* LSCF starts [VdF] */
  double delta_rho_lscf=0., rho_plus_p_theta_lscf=0.;
  double delta_lscf=0., theta_lscf=0.;
  /* LSCF ends [VdF] */
  /** - ncdm sector begins */
  int n_ncdm;
  ...
  if (_scalars_) {
    ...
    if (pba->has_lscf == _TRUE_){
      ...
      delta_lscf = delta_rho_lscf/pvecback[pba->index_bg_rho_lscf];
      theta_lscf = rho_plus_p_theta_lscf/(pvecback[pba->index_bg_rho_lscf]+pvecback[pba->index_bg_p_lscf]);
    ...
    if (ppt->gauge == synchronous) {
      ...
      /* LSCF starts [VdF] */
      if (pba->has_lscf == _TRUE_) {
        delta_lscf += alpha*(-3.0*H*(1.0+pvecback[pba->index_bg_p_lscf]/pvecback[pba->index_bg_rho_lscf]));
        theta_lscf += k*k*alpha;
      }
      /* LSCF ends [VdF] */
    ...
    /* LSCF starts [VdF] */
    /* Scalar field lscf*/
    class_store_double(dataptr, delta_lscf, pba->has_lscf, storeidx);
    class_store_double(dataptr, theta_lscf, pba->has_lscf, storeidx);
    /* LSCF ends [VdF] */
...
int perturbations_derivs(double tau,
  ...
  if (_scalars_) {
    ...
    if (pba->has_lscf == _TRUE_) {
      ...
      dy[pv->index_pt_phi_lscf] = y[pv->index_pt_phi_prime_lscf];

      /** - ----> Klein Gordon equation */

      dy[pv->index_pt_phi_prime_lscf] =  - 2.*a_prime_over_a*y[pv->index_pt_phi_prime_lscf]
        - metric_continuity*pvecback[pba->index_bg_phi_prime_lscf] //  metric_continuity = h'/2
        - (k2 + a2*pvecback[pba->index_bg_ddV_lscf])*y[pv->index_pt_phi_lscf]; //checked
